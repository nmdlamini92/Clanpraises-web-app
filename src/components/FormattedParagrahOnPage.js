...
export default function FormattedParagraphOnPage({ text }) {
...
function Line({
  ...
  return (
    <p
      className="px-0.5 py-0 my-0 rounded-sm cursor-pointer leading-none transition-all duration-200 w-fit text-[12px] sm:text-[14px] md:text-[14px] lg:text-[15px]"
