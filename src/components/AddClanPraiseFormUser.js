...
export default function AddClanPraiseFormUser() {
            ...
            <div className="bg-amber-600/20 p-3 border rounded border-amber-500">
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col">
                  ...
                  {/*<textarea className="ClanPraiseInput text-sm mt-3 border rounded border-amber-500" name="englishVersion" placeholder="clan info/history/customs  *optional*" value={values2.englishVersion}  
                ...
                <button className={`mt-1 p-1 px-2  border-black ${isLoading ? "bg-amber-200" : " bg-amber-400"}`} 
                  type='submit'>{isLoading ? "Loading..." : "Add Clan"}</button>
              </form>
            </div>
      </>
    );
