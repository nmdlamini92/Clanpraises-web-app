...
export default function CardHistoryInteractive ({ title, imageUrl, description, createdAt, username, rating, views, definitions, reviews, comments, onClick, linkUrl }: CardProps) {
  
  //const [clicked, setClicked] = useState(false); 
  const [isTouched, setIsTouched] = useState(false);

  const handleClick = () => {
    setIsTouched(prev => !prev); // ← Step 3
